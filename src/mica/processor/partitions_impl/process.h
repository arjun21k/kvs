    ...
    if (index < count) {
      ...
      switch (operation) {
        ...
        case Operation::kTest:
          accept = concurrent_read_ || owner_lcore_id == lcore_id || lcore_id == 0;
          break;
        ...
        case Operation::kIncrement:
          accept = concurrent_write_ || owner_lcore_id == lcore_id || lcore_id == 0;
          break;
        default:
          accept = true;
          break;
      ...
      if (!accept) {
        ...
        switch (operation) {
          ...
          case Operation::kGet: {
            ...
            //     lcore_id);
	    //printf("lcore %2" PRIu16 ": Processing GET\n", lcore_id);
	    //printf("Key = %" PRIu64 "\n", *ra.get_key(index));
